<!-- sidebar -->
<body class="bg-white font-family-karla"></body>
<div class="grid grid-cols-3 gap-4">
    <div class="col-start-1 col-end-7 flex-col items-center px- ">
        <img class="object-none object-top bg-yellow-300 w-50 h-50 ..." src="https://source.unsplash.com/collection/1346951/1000x500?sig=1">
    </div>
